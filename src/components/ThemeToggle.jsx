...
export default function ThemeToggle({ isDark, onToggle }) {
  return (
    <div className="flex items-center">
      <label id="theme-toggle-button" className="cursor-pointer select-none">
        <input 
          type="checkbox" 
          id="toggle" 
          checked={isDark} 
        ...
        />
        <svg viewBox="0 0 69.667 44" xmlns="http://www.w3.org/2000/svg" className="w-[58px] sm:w-[68px] h-auto drop-shadow-md">
          <defs>
            {/* Orange to Yellow glowing sun gradient */}
            <radialGradient id="sunGlowGradient" cx="40%" cy="40%" r="60%">
              <stop offset="0%" stopColor="#FEF08A" />
              <stop offset="45%" stopColor="#F59E0B" />
              <stop offset="90%" stopColor="#EA580C" />
              <stop offset="100%" stopColor="#C2410C" />
            </radialGradient>
            <linearGradient id="sunOuterGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <g transform="translate(3.5 3.5)" id="Component_15_1">
            ...
            {/* Pill Container */}
            <g id="container-group" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
              <rect 
                fill="#83cbd8" 
            ...
            <g transform="translate(2.333 2.333)" id="button">
              ...
              {/* SUN with Fading Orange and Yellow Sun Colors */}
              <g id="sun">
                <g id="sun-outer-group" transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                  <circle 
                    fill="url(#sunOuterGradient)" 
                ...
                <g id="sun-mid-group" transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                  <path 
                ...
                {/* Sun Core with Orange-Yellow Radial Fade */}
                <circle 
              ...
              {/* MOON with craters */}
              <g id="moon">
                <g id="moon-group" transform="matrix(1, 0, 0, 1, -31.5, -5.83)">
                  <circle 
                    fill="#cce6ee" 
            ...
            {/* Day Cloud */}
            <g id="cloud-group" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
              <path 
                fill="#fff" 
